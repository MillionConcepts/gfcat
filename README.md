...
**A secondary output of this project that may be of general interest is a catalog of 120-second depth photometry for all "MIS style" observations collected by GALEX through GR7.** These data were previously hosted here but have been deprecated.

**The third output of this project is in preparation. 30-second depth photometry and a selection of intra-visit variables for all MIS style observations collected by GALEX through GR7.**
